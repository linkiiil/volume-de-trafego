...
I-94_Mobility_Intelligence.pdf: Apresentação em slides sintetizando os insights de negócio, diagnóstico preditivo e conclusões do projeto.

shap_summary.svg: Gráfico demonstrativo da importância global das features no modelo (SHAP Summary Plot), mapeando as variáveis de maior impacto no tráfego.

shap_waterfall_top5.svg: Gráfico de cascata SHAP demonstrando a auditabilidade local, ilustrando como as top 5 variáveis influenciaram o resultado de uma previsão específica (positiva ou negativamente) a partir do valor base.

Projeto - Diabetes.ipynb: Notebook de um projeto analítico complementar contido neste mesmo repositório, focado em predição de risco de saúde pública
---
